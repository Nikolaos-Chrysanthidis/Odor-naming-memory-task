...
PATH = '/home/nik/BCPNNSim-olfaction/PatternGeneration/DistanceMatrices/'
np.random.seed(0) 
####Sigmoid Type 1
...
def get_odor_dmat():
    ...
    simmat = pd.read_csv('/home/nik/BCPNNSim-olfaction/PatternGeneration/DistanceMatrices/Odors_MeanRatedSimilarity.csv',index_col=0)
    distmat = 1-simmat
...
def main(H=15, M=15, npat=5, mean_overlap=0, non_standard=0, i=None, fp=None, emax=20):    
    ...
    if non_standard not in [1,5]: 
        ...
        save_fname = 'GMCPatterns/NEW/odors_npat{}_emax{}_H{}_M{}_dampen_factor{}'.format( 
                                                                        npat, emax, H,M,dampen_factor).replace('.','_') 
        ...
        if save4animation:
            animation_fname = '/home/nik/BCPNNSim-olfaction/animation/'+'w2v_single_labels_H{}_M{}_dampen_factor{}'.format(H,M,dampen_factor).replace('.','_')
